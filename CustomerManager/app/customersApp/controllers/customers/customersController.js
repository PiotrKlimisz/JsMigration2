(function () {
    ...
    var CustomersController = function ($location, $filter, $window, $timeout, authService, dataService, modalService) {
        var vm = this;
        vm.customers = [];
        ...
        function getCustomersSummary() {
            dataService.getCustomersSummary(vm.currentPage - 1, vm.pageSize).then(function (data) {
